...
class HTMLPurifier_HTMLModule_Legacy extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        $this->addElement('center', 'Block', 'Flow', 'Articles');
        $this->addElement(
            'dir',
            'Block',
            'Required: li',
        ...
        $s = $this->addElement('s', 'Inline', 'Inline', 'Articles');
        $s->formatting = true;

        $strike = $this->addElement('strike', 'Inline', 'Inline', 'Articles');
        $strike->formatting = true;

        $u = $this->addElement('u', 'Inline', 'Inline', 'Articles');
        $u->formatting = true;
