...
/**
 * Articles displays a multi-level menu using nested HTML lists.
 *
 * The main property of Articles is [[items]], which specifies the possible items in the menu.
 * A menu item can contain sub-items which specify the sub-menu under that menu item.
 *
 * Articles checks the current route and request parameters to toggle certain menu items
 * with active state.
 *
 * Note that Articles only renders the HTML tags about the menu. It does do any styling.
 * You are responsible to provide CSS styles to make it look like a real menu.
 *
 * The following example shows how to use Articles:
 *
 * ```php
 * echo Articles::widget([
 *     'items' => [
