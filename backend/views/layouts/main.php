...
<header>
    <div class="headerpanel">
        <div class="logopanel">
            <h2><a href="<?=Yii::$app->homeUrl?>">博客管理系统</a></h2>
        </div><!-- logopanel -->
        ...
        <div class="leftpanelinner">
            ...
            <div class="media leftpanel-profile">
                ...
                <div class="media-body">
                    <h4 class="media-heading"><?=$this->params['d_users']['bi_name']?><a data-toggle="collapse" data-target="#loguserinfo" class="pull-right"><i class="fa fa-angle-down"></i></a></h4>
                    <?php if($this->params['d_users']['role'] == 1):?>
                        <span>超级管理员</span>
                    <?php else:?>
                        <span>管理员</span>
                    <?php endif?>
            ...
            <div class="leftpanel-userinfo collapse" id="loguserinfo">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        <span class="pull-right"><?=$this->params['d_users']['phone']?></span>
                    </li>
                </ul>
