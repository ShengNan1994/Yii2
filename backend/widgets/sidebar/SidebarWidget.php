    ...
    public function init()
    {
        $this->items = [
            ...
            ['label' =>'<a href=""><i class="fa fa-th-list"></i><span>内容管理</span></a>','options'=>['class'=>'nav-parent'],'items'=>[
                    ...
                    ['label'=>'个人中心','url'=>['cat/index'],'items'=>[
                        ['label'=>'创建文章','url'=>['cat/create'],'visible'=>false],
                        ['label'=>'更新文章','url'=>['cat/update'],'visible'=>false],
                        ]                        
                    ],
                ['label'=>'密码修改','url'=>['member/index']],
                ]
            ],
            ['label' =>'<a href=""><i class="fa fa-user"></i><span>系统管理</span></a>','options'=>['class'=>'nav-parent'],'items'=>[
                    ['label'=>'用户管理','url'=>['member/index']],
                    ['label'=>'标签管理','url'=>['tag/index']],
                    ['label'=>'博客菜单管理','url'=>['tag/index']],
